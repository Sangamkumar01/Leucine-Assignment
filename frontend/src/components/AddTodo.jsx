...
export default function AddTodo({ input, setInput, onAdd }) {
  return (
    <div className="w-full flex gap-2 mb-4">
      <input
        className="flex-1 rounded-lg border border-purple-200 px-4 py-3 text-lg focus:outline-none focus:ring-2 focus:ring-purple-400 bg-gray-50 shadow-sm placeholder-gray-400 text-gray-800"
        type="text"
